...
//写好分页的查询语句
$sqlstr_page="SELECT * FROM `web_nr` WHERE web_mk like '%".$web_mk."%' and state=0 order BY ID desc LIMIT ".$start.", 10";
//发送分页查询语句
...
//这里获取分类总数
$sqlstr_total="SELECT * FROM `web_nr` WHERE state=0 and web_mk like '%".$web_mk."%'";
